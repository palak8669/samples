...
class VideoSource { // eslint-disable-line no-unused-vars
  ...
  updateVideoVisibility() {
    if (this.video_.parentNode && !this.visibility_) {
      ...
      // inputVideoContainer.appendChild(this.video_);
      inputVideoContainer.parentNode.insertBefore(
          this.video_, inputVideoContainer);
    }
  }
  /** @override */
  async getMediaStream(src) {
    ...
    // this.video_.src = '../../../video/mixed-content.webm';
    // this.video_.src = '../../../video/pano.webm';
    this.video_.src = src;
    this.video_.load();
    this.video_.play();
    this.updateVideoVisibility();
